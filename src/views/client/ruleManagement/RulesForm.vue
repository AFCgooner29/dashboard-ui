...
export default {
  ...
  methods: {
      getFormStructure() {
          var formStructure = formConfigs.RULE_FORM; // Encapsulated logic to fetch form structure
      ...
      async fetchModelData() {
          try {
              ...
              jsonData = reverseSelectFields(jsonData.data, formConfigs.RULE_FORM, formConfigs.RULE_FORM.lovReverseMap);
              return jsonData;
          } catch (error) {
              console.error(error);
              throw error;
