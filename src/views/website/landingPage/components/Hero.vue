...
.hero {
    ...
    background: linear-gradient(173deg, #000000, #000000 28%, #363636 43%, #818181 56%, #969696 78%, #fff calc(78% + 4px));
}
...
@media (max-width: 768px) {
    .hero {
        ...
        gap: 30px;
        margin-bottom: 10%;
        background: linear-gradient(173deg, #000000, #000000 28%, #272727 43%, #363636 56%, #535353 78%);
        height: 700px;
    }
